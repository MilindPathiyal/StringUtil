...
public class StringDriver
{
    public static void driver()
    {
        ...
        input = in.nextLine();
        System.out.println("The cleaned string is " +  
        ...
        input = in.nextLine();
        System.out.println("The first vowel is at position " + 
            StringUtil.findFirstVowel(input));
        
        System.out.println("Enter a word to piggify");
        input = in.nextLine();
        System.out.println("The piggified string is " +  
            StringUtil.piggify(input));
             
        System.out.println("Enter a sentence to piggify");
        input = in.nextLine();
        System.out.println("The piggified sentence is " +  
            StringUtil.piggifySentenceExtra(input));
